...
- Реакции на посты (👍 / 😐 / 👎, одна на пост) и комментарии с ответами (один уровень вложенности, ответ на ответ попадает в ту же ветку с меткой «В ответ: Имя»)
- Удаление своих постов и комментариев
- Mute и блокировка знакомого без разрыва «знакомства» — mute прячет его посты и комментарии только от тебя, блокировка скрывает их в обе стороны (вместе с комментарием скрывается и вся ветка ответов под ним)
