...
- Комнаты: отдельная лента и чат для тех, кого позвали — пост адресуется в общую ленту, в несколько комнат сразу или только в комнату; сообщения приходят по realtime-подписке, с непрочитанными и пушами; комната на двоих называется именем собеседника, группа переименовывается
...
- [Эксплуатация](docs/operations.md) — задания по расписанию, секреты, релиз, рассылка уведомления об обновлении
