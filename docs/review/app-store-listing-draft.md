# App Store Listing Draft — Amicus (English, U.S.)

Draft for review before entering into App Store Connect. Nothing has been
submitted; "Add for Review" has not been touched.
...
Most social apps optimize for endless scrolling. Amicus does the opposite — a digital detox by design. Your feed isn't infinite and isn't ranked by an algorithm chasing your attention. You see what your Connections actually share, at your own pace, without pressure to keep scrolling.
...
*(needs a real URL — GitHub repo issues page, or a simple support page/email
landing page. Suggest: `https://github.com/tiltozavr2545/amicus/issues` if
you're fine with a public GitHub-based support channel, otherwise provide
one.)*

## Marketing URL (optional)

*(optional — could link to the GitHub repo README, or leave blank)*
...
- All copy above is a **draft** — please read and edit before it goes into
  App Store Connect. Nothing has been entered yet.
- Sign-in/App Review info: Amicus requires an account to test. You'll need
  to provide App Review with a working test account (email + password) in
