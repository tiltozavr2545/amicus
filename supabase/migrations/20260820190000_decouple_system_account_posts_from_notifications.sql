-- 20260820170000 tied 'app_update' notifications to every system-account
-- post. That coupling is gone: a system-account post no longer enqueues
-- anything on its own. notify_system_account and the 'app_update' kind stay
-- in place for whatever sends that notification going forward.
