...
`0.11.0+19`. Есть: вход/регистрация, профиль с аватаром, знакомства через
invite-коды, лента с постами (текст + одно фото), реакциями и комментариями с
одноуровневой вложенностью, mute/блокировка, две локали, тёмная тема.
...
push-уведомления, модерация/жалобы, web-версия, свой backend, iOS.
